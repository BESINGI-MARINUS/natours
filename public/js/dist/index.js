...
})({"34YjQ":[function(require,module,exports,__globalThis) {
...
if (passwdUpdateForm) passwdUpdateForm.addEventListener('submit', async function(e) {
    e.preventDefault();
    document.querySelector('.change-passwd-btn').textContent = 'Updating...';
    const passwordPrevious = passwdUpdateForm.querySelector('#password-current').value;
    const password = passwdUpdateForm.querySelector('#password').value;
    const passwordConfirm = passwdUpdateForm.querySelector('#password-confirm').value;
...
if (btnBookTour) btnBookTour.addEventListener('click', async function(e) {
    e.target.textContent = 'Processing...';
    e.target.style.opacity = '0.6 ';
    const { tourId } = e.target.dataset;
    const res = await (0, _stripe.bookTour)(tourId);
});

},{"./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC"}],"7yHem":[function(require,module,exports,__globalThis) {
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const stripe = Stripe('pk_test_51SCceP2EVZexQnETpywwYd5Qnz4kpYlvcWwWYa6zXzo59PwHJ87fn91st8j8scXSl0PDxcV3XEMd4TRiz8fex3UZ00BWA5sBuj');
...
},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["34YjQ","f2QDv"], "f2QDv", "parcelRequire11c7", {})
